    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="w-full space-y-6">
          ...
          <Card className="rounded-[40px] border-none shadow-[0_20px_60px_rgba(0,0,0,0.05)] bg-white/70 backdrop-blur-xl overflow-hidden group">
            <div className="p-8 border-b border-white/50 bg-white/30 flex items-center gap-4 text-red-600">
              <div className="w-10 h-10 rounded-full bg-red-100 flex items-center justify-center shadow-lg shadow-red-100/50">
                <HeartPulse className="w-5 h-5" />
              </div>
              <h3 className="text-xl font-black tracking-tight">Dados Médicos e Emergência</h3>
            </div>
            <CardContent className="p-8 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-slate-50/50 p-4 rounded-3xl border border-slate-100">
                  <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider mb-2">Tipo Sanguíneo</p>
                  <Badge className="bg-red-600 text-white border-none font-black text-lg px-4 py-1 rounded-xl">
                    {pilot.emergencyContact?.bloodType || 'N/A'}
                  </Badge>
                </div>

                <div className="bg-slate-50/50 p-4 rounded-3xl border border-slate-100">
                  <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider mb-2">Contato de Emergência</p>
                  <p className="font-bold text-slate-700">{pilot.emergencyContact?.emergencyContactName || 'Não informado'}</p>
                  <p className="text-sm font-bold text-red-600 mt-1">{pilot.emergencyContact?.emergencyPhone || ''}</p>
                </div>
              </div>
              ...
              <div className="bg-red-50/50 p-6 rounded-3xl border border-red-100/50">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-[10px] font-black uppercase text-red-400 tracking-wider">Alergias e Observações Médicas</p>
                </div>
                <p className="text-sm font-bold text-slate-600 leading-relaxed italic">
                  {pilot.emergencyContact?.allergies || 'Nenhuma alergia ou restrição médica informada pelo piloto.'}
                </p>
              </div>
            </CardContent>
          </Card>
