...
export const StatusList = () => {
  ...
  return (
    <div className="flex flex-col gap-6 p-4 md:p-8 animate-in fade-in duration-500">
      ...
      {filteredPilots && (
        <Card className="border border-border shadow-[0_10px_40px_rgba(0,0,0,0.04)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.4)] bg-card/70 backdrop-blur-xl overflow-hidden rounded-2xl transition-all duration-500">
              ...
              <Table>
                <TableHeader className="bg-muted/30">
                  <TableRow className="hover:bg-transparent border-border">
                    <TableHead className="w-[300px] font-bold text-foreground/80">Piloto</TableHead>
                    <TableHead className="hidden md:table-cell text-center font-bold text-foreground/80">Sangue</TableHead>
                    <TableHead className="hidden md:table-cell text-center font-bold text-foreground/80">Emergência</TableHead>
                    <TableHead className="hidden md:table-cell font-bold text-foreground/80">Alergias</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {filteredPilots.length > 0 ? (
                    filteredPilots.map((pilot) => (
                      <TableRow key={pilot.userId} className="group hover:bg-primary/[0.04] border-border transition-colors">
                        <TableCell className="py-4">
                          ...
                          <div className="mt-4 md:hidden flex flex-col gap-4 bg-muted/20 p-3 rounded-xl border border-border animate-in fade-in slide-in-from-top-1">
                            <div className="flex items-start gap-6">
                              ...
                              <div className="flex flex-col gap-1 flex-1">
                                ...
                                {pilot.allergies ? (
                                  <div className="text-sm font-bold text-destructive italic leading-tight" title={pilot.allergies}>
                                    {pilot.allergies}
                                  </div>
                                ) : (
                                  <span className="text-muted-foreground/30 text-[10px]">---</span>
                            ...
                            <div className="col-span-2 flex flex-col gap-1 border-t border-border pt-2">
                              ...
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                {pilot.emergencyPhone && (
                                  <div className="flex items-center gap-1 text-destructive font-mono text-[11px] bg-destructive/10 px-2 py-0.5 rounded-full border border-destructive/20 shrink-0">
                        ...
                        <TableCell className="hidden md:table-cell text-center">
                          <div className="flex flex-col items-center gap-1">
                            ...
                            {pilot.emergencyPhone && (
                              <div className="flex items-center gap-1 text-destructive font-mono text-[12px]">
                        ...
                        <TableCell className="hidden md:table-cell">
                          {pilot.allergies ? (
                            <div className="max-w-[auto] text-md font-bold text-destructive bg-destructive/10 px-2 py-1 rounded-md border border-destructive/20 italic" title={pilot.allergies}>
                              {pilot.allergies}
                            </div>
                          ) : (
