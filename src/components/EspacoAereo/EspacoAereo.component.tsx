  ...
  return (
    <section id="espaco-aereo" className="bg-background">
      ...
      <div ref={parallaxRef} className="relative h-[60vh] md:h-[70vh] overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-background/40 via-transparent to-background dark:from-black/40 dark:to-background" />
        <div className="absolute inset-0 flex items-center justify-center">
          <ScrollReveal>
            <h2 className="text-3xl sm:text-5xl font-heading font-bold text-foreground dark:text-white drop-shadow-xl dark:drop-shadow-[0_4px_20px_rgba(0,0,0,0.5)] text-center transition-colors duration-500">
              Espaço <span className="text-primary">Aéreo</span>
            </h2>
          </ScrollReveal>
        </div>
      </div>
